...
Playiku is a self-hosted collection of polished casual browser games. It includes Sudoku, Minesweeper, 2048, Nonogram, Snake, and Klondike Solitaire in a responsive, accessible ishiku interface.
